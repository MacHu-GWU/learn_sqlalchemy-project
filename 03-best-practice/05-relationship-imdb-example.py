...
person_and_role = Table(
    "person_and_role", Base.metadata,
    Column("person_id", Integer, ForeignKey("person.id"), primary_key=True),
    Column("role_id", Integer, ForeignKey("role.id"), primary_key=True),
)

movie_and_director = Table(
    "movie_and_director", Base.metadata,
    Column("movie_id", Integer, ForeignKey("movie.id"), primary_key=True),
    Column("director_id", Integer, ForeignKey("person.id"), primary_key=True),
)

movie_and_writer = Table(
    "movie_and_writer", Base.metadata,
    Column("movie_id", Integer, ForeignKey("movie.id"), primary_key=True),
    Column("writer_id", Integer, ForeignKey("person.id"), primary_key=True),
)

movie_and_star = Table(
    "movie_and_star", Base.metadata,
    Column("movie_id", Integer, ForeignKey("movie.id"), primary_key=True),
